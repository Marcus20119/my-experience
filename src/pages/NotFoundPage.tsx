...
function NotFoundPage() {
  ...
  return (
    <div className="min-w-screen relative flex min-h-screen items-center overflow-hidden bg-blue-100 p-5 lg:p-20">
      <div className="relative min-h-full min-w-full flex-1 items-center rounded-3xl bg-white p-10 text-center text-gray-800 shadow-xl md:flex md:text-left lg:p-20">
        <div className="w-full md:w-1/2">
          ...
          <div className="mb-10 font-light text-gray-600 md:mb-20">
            <h1 className="mb-10 text-3xl font-black text-primary lg:text-5xl">
              {t('common.message.pageNotFound', {
                lng: language,
              })}
            </h1>
            <p>
              {t('common.message.linkNotFound', {
                lng: language,
              })}
            </p>
            <p>
              {t('common.message.contactAdmin', {
                lng: language,
              })}
            </p>
          </div>
          <div className="mb-20 md:mb-0">
            <Button type="primary">{t('common.button.back')}</Button>
          </div>
        </div>
          ...
          >
            ...
            <g id="OBJECTS">
              ...
              <g>
                ...
                />
                <path
                  className="opacity-30 hue-rotate-30"
              ...
              <g>
                <path
                  ...
                  fill={COLOR.neutral['200']}
                />
                <circle cx="97.11" cy="40.45" fill={COLOR.primary} r="26.45" />
                <path
      ...
      <div className="pointer-events-none absolute -top-64 right-20 h-96 w-64 -rotate-45 transform rounded-full bg-blue-200 bg-opacity-30 md:-top-96 md:right-32 md:h-full md:w-96" />
      <div className="pointer-events-none absolute -bottom-96 right-64 h-full w-96 -rotate-45 transform rounded-full bg-primary opacity-10" />
    </div>
  );
}
